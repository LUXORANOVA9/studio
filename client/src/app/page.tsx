  ...
  if (invalid) {
    return (
      <motion.div className="p-8 text-center text-red-500" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <img src="/assets/brand-logo.svg" alt="LuxoraNova Logo" className="mx-auto mb-4 w-24 h-24" initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5 }} />
