...
# Define path for legacy HTML file to be deployed to Firebase
legacy_html_path = Path("/mnt/data/legacy.html")

# HTML content provided by the user
legacy_html_content = """<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
# Save to file
legacy_html_path.write_text(legacy_html_content)
legacy_html_path
